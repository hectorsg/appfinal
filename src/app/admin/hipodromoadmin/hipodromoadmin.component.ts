...
export class HipodromoadminComponent implements OnInit {
  ...
  viewHipodromo(item){
    ...
    this.app.getRacesAll(this.theHipodromo.id).subscribe(item =>{
      ...
      this.racesLunAr = {nroCarreras:this.racesLun, dia:'Lunes'}
      if(this.racesLun > 0){
      ...
      this.racesMarAr = {nroCarreras:this.racesMar, dia:'Martes'}
      if(this.racesMar>0){
      ...
      this.racesMieAr = {nroCarreras:this.racesMie, dia:'Miercoles'}
      if(this.racesMie > 0 ){
      ...
      this.racesJueAr = {nroCarreras:this.racesJue, dia:'Jueves'}
      if(this.racesJue > 0){
      ...
      this.racesVieAr = {nroCarreras:this.racesVie, dia:'Viernes'}
      if(this.racesVie > 0){
      ...
      this.racesSabAr = {nroCarreras:this.racesSab, dia:'Sabado'}
      if(this.racesSab > 0){
      ...
      this.racesDomAr= {nroCarreras:this.racesDom, dia:'Domingo'}
      if(this.racesDom > 0 ){
