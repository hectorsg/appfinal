...
@NgModule({
  declarations: [AppComponent,EpisodioComponent,SafePipe,HipodromoComponent,EncuestasComponent, AccComponent,
     AddEpisodioComponent,LoginemailComponent,HipodromoadminComponent, GacetaComponent,RedesComponent,PronosticoComponent,PronosticoadminComponent, StoriesadminComponent],
  ...
  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule,FormsModule,
    ...
    AngularFireAnalyticsModule,PipeModule,DragDropModule ,
 
   AngularFireAuthModule, AngularFirestoreModule],
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Downloader, GooglePlus,AdMobFree,InAppBrowser],
